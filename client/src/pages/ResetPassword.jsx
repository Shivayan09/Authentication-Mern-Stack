...
const ResetPassword = () => {
    ...
    return (
        <div className='flex items-center justify-center min-h-screen bg-[url("/bg_img.png")]'>
            ...
            {!isEmailSent &&
                <form className='bg-slate-900 p-8 rounded-lg' onSubmit={onSubmitEmail}>
            ...
            {!isOtpSubmitted && isEmailSent &&
                <form className='bg-slate-900 p-8 rounded-lg' onSubmit={inSubmitOtp}>
            ...
            {isOtpSubmitted && isEmailSent &&
                <form className='bg-slate-900 p-8 rounded-lg' onSubmit={onSubmitNewPassword}>
